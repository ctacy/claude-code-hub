  ...
  return (
    <TooltipProvider delayDuration={200}>
      <Tooltip>
        ...
        >
          <div className="max-h-[calc(var(--radix-tooltip-content-available-height)-3rem)] overflow-y-auto overscroll-contain leading-loose whitespace-pre-wrap break-words">
            {text}
          </div>
        </TooltipContent>
      </Tooltip>
